...
#define DRIVER_NAME "drv1"
#define DRIVER_PATH ".\\drv1.sys"
...
BOOL LoadDriver(char* lpszDriverName, char* lpszDriverPath)
{
	...
	hServiceDDK = CreateService( hServiceMgr,
		...
		NULL,  // GroupOrder, 驱动启动顺序. HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\GroupOrderList
		NULL,  
		NULL,  
		NULL,  
		NULL);  
...
{
	//测试驱动程序  
	HANDLE hDevice = CreateFile("\\\\.\\drv1",
